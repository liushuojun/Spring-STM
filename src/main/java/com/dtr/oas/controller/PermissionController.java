...
import com.dtr.oas.dto.PermissionDTO;
...
public class PermissionController {
    ...
    public String listPermissions(Model model) {
        logger.info("IN: Permission/list-GET");
        ...
        if (!model.containsAttribute("permissionDTO")) {
            logger.info("Adding PermissionDTO object to model");
    ...
    public String addPermission(@Valid @ModelAttribute PermissionDTO permissionDTO,
        ...
        logger.info("IN: Permission/add-POST");
        logger.info("  DTO: " + permissionDTO.toString());
 
        if (result.hasErrors()) {
            logger.info("PermissionDTO add error: " + result.toString());
    ...
    public String editPermission(@Valid @ModelAttribute PermissionDTO permissionDTO,
            BindingResult result, RedirectAttributes redirectAttrs,
            @RequestParam(value = "action", required = true) String action) throws DuplicatePermissionException {
 
        logger.info("IN: Permission/edit-POST: " + action);
        ...
        if (action.equals(messageSource.getMessage("button.action.cancel", null, Locale.US))) {
            ...
            logger.info("Permission-edit error: " + result.toString());
            redirectAttrs.addFlashAttribute("org.springframework.validation.BindingResult.permissionDTO", result);
            redirectAttrs.addFlashAttribute("permissionDTO", permissionDTO);
            ...
            logger.info("Permission/edit-POST:  " + permissionDTO.toString());
            try {
    ...
    public String editPermissionPage(@RequestParam(value = "id", required = true)
        ...
        logger.info("IN: Permission/edit-GET:  ID to query = " + id);
        ...
        try {
            if (!model.containsAttribute("permissionDTO")) {
                ...
                logger.info("Permission/edit-GET:  " + permissionDTO.toString());
                model.addAttribute("permissionDTO", permissionDTO);
            }
    ...
    public String deletePermission(
        ...
        logger.info("IN: Permission/delete-GET | id = " + id + " | phase = " + phase + " | " + permission.toString());
        ...
        if (phase.equals(messageSource.getMessage("button.action.cancel", null, Locale.US))) {
            ...
            logger.info("     deleting permission : " + permission.toString());
    ...
    public Permission getPermission(PermissionDTO permissionDTO) throws RoleNotFoundException {
        ...
        logger.info("  PERM: " + perm.toString());
        return perm;
    }
}
